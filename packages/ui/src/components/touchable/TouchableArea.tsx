...
import { withAnimated } from '@klectik/ui/src/components/factories/animated';
import { AnimatedTouchableBox, TouchableBoxProps } from './TouchableBox';
import { TouchableAreaProps } from './types';
import { defaultHitslopInset } from '@klectik/ui/src/theme';
